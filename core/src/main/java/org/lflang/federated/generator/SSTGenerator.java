...
public class SSTGenerator {
  ...
  private static String updatePath(String line, String base) {
    ...
    private static void copyAuthAndConfigsAndKeys(FederationFileConfig fileConfig, List<FederateInstance> federates, boolean usePermanentDistKey, boolean useDocker)
    throws IOException {
